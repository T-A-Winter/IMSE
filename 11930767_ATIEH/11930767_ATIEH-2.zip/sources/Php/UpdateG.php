...
if (isset($_POST['submit'])) {
    ...
    if ($input_password === $correct_password) {
        ...
        if ($database->updateGericht($GerichtID, $newName, $newPrice)) {
            $success = "Gericht successfully updated.";
        } else {
            $error = "Error updating Gericht.";
        }
    } else {
...
<div class="container">
    ...
    <form method="post">
        <div>
            ...
            <input id="GerichtID" name="GerichtID" type="text" required>
        </div>
        <div>
            <label for="newName">New GerichtName:</label>
            <input id="newName" name="newName" type="text" required>
        </div>
        <div>
            <label for="newPrice">New Price:</label>
            <input id="newPrice" name="newPrice" type="text" required>
        </div>
        <div>
        ...
        <div>
            <button type="submit" name="submit">Update Gericht</button>
        </div>
    </form>
</div>
</body>
